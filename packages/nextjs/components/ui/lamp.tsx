  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        whileInView={{ opacity: 1, y: -360 }}
        transition={{
          delay: 0.5,
          duration: 0.6,
          ease: "easeInOut",
        }}
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[8.5rem] z-[100] text-white text-[52px] font-medium tracking-wide"
      >
        Why us?
      </motion.p>
